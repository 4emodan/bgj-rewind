...
public class CharacterController2D : MonoBehaviour
{
	...
	[SerializeField] public Transform m_GroundCheck1;                           // A position marking where to check if the player is grounded.
	[SerializeField] public Transform m_GroundCheck2;                           // A position marking where to check if the player is grounded.
	...
	private void FixedUpdate()
	{
		...
		Collider2D[] colliders = new Collider2D[colliders1.Length + colliders2.Length];
		colliders1.CopyTo(colliders, 0);
		colliders2.CopyTo(colliders, colliders1.Length);
